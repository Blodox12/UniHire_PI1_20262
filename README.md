...
- Backend: Python 3.10+ with Django, SQLite, and JWT (API implemented in `backend/django_unihire`).
...
The Django project serves both simple pages and the API. The API endpoints are under `/api/` and the home page is `/`.
